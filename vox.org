...
# Time-stamp: <2023-12-11 23:03:04 krylon>
#
...
* Clock table
  ...
  #+CAPTION: Clock summary at [2023-12-11 Mo 23:03]
  | Headline                   | Time       |            |      |      |
  |----------------------------+------------+------------+------+------|
  | *Total time*               | *2d 19:55* |            |      |      |
  |----------------------------+------------+------------+------+------|
  | *Components [0/0]*         | *2d 19:55* |            |      |      |
...
*** TODO Player
    ...
    :END:
**** TODO Pump up the volume                                        :feature:
     :LOGBOOK:
